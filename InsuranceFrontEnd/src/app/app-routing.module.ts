...
const routes: Routes = [
  ...
  { path: 'agent', component: AgentDataComponent },
  { path: 'agent/login', component: AgentLoginComponent },
  { path: 'employee/login', component: EmployeeLoginComponent },
  { path: 'customer/login', component: CustomerLoginComponent },
  { path: 'payment', component: PaymentDataComponent },
  { path: 'policy', component: PolicyDataComponent },
  { path: 'plan', component: PlanDataComponent },
  { path: 'customer/header', component: CustomerHeaderComponent },
  { path: 'agent/header', component: AgentHeaderComponent },
  { path: 'employee/header', component: EmployeeHeaderComponent },
  { path: 'claim', component: ClaimComponent },
  { path: 'commission', component: CommissionComponent },
  { path: 'complaint', component: ComplaintComponent },
  { path: 'password', component: UpdatePasswordComponent },
  { path: 'customer/policy', component: PolicyCustomerComponent },
